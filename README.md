...
본 프로젝트는 전기자전거 대여 과정에서 발생할 수 있는 QR 코드 피싱, 데이터 위조 등의 보안 위협을 탐지하고 차단하는 **지능형 보안 대여 시스템**의 데이터 흐름을 정의합니다.

## 🚲 시스템 아키텍처 및 데이터 흐름도

![시스템 흐름도](./1000002706.jpg)
*참고: 위 이미지는 시스템의 전체적인 데이터 흐름과 보안 검증 단계를 나타냅니다.*
